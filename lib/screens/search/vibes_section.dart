...
class VibesSection extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> vibes = const [
    ...
    {"title": "House", "color": Colors.brown},
    {"title": "Feel Good", "color": Colors.cyan},
    {"title": "At Home", "color": Colors.deepPurple},
    {"title": "Healing Era", "color": Colors.grey},
    {"title": "Study", "color": Colors.redAccent},
    {"title": "Folk", "color": Colors.greenAccent},
    {"title": "Indie", "color": Colors.blueGrey},
    {"title": "Soul", "color": Colors.black54},
    {"title": "Country", "color": Colors.black54},
    {"title": "Latin", "color": Colors.black54},
    {"title": "Rock", "color": Colors.black54},
  ];
